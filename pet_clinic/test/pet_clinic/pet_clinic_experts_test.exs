defmodule PetClinic.PetClinicExpertsTest do
  ...
  describe "experts" do
    ...
    test "create_pet_health_expert/1 with valid data creates a pet_health_expert" do
      ...
      assert {:ok, %PetHealthExpert{} = pet_health_expert} = PetClinicExperts.create_pet_health_expert(valid_attrs)
    ...
    test "create_pet_health_expert/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = PetClinicExperts.create_pet_health_expert(@invalid_attrs)
    end
    ...
    test "update_pet_health_expert/2 with valid data updates the pet_health_expert" do
      ...
      assert {:ok, %PetHealthExpert{} = pet_health_expert} = PetClinicExperts.update_pet_health_expert(pet_health_expert, update_attrs)
    ...
    test "update_pet_health_expert/2 with invalid data returns error changeset" do
      pet_health_expert = pet_health_expert_fixture()
      assert {:error, %Ecto.Changeset{}} = PetClinicExperts.update_pet_health_expert(pet_health_expert, @invalid_attrs)
    ...
    test "delete_pet_health_expert/1 deletes the pet_health_expert" do
      pet_health_expert = pet_health_expert_fixture()
      assert {:ok, %PetHealthExpert{}} = PetClinicExperts.delete_pet_health_expert(pet_health_expert)
      assert_raise Ecto.NoResultsError, fn -> PetClinicExperts.get_pet_health_expert!(pet_health_expert.id) end
    end
